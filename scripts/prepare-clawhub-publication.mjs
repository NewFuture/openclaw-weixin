...
function main() {
  try {
    ...
    if (
      ...
      throw new Error(
        "CLAWHUB_BOUNDARY_REPORT, CLAWHUB_BOUNDARY_CHECK_REPORT, CLAWHUB_BOUNDARY_CHECK_REQUEST, CLAWHUB_BOUNDARY_MARKER, and NPMJS_PUBLISHED_BEFORE_JOB are required",
      );
    }
